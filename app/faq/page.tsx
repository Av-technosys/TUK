      ...
      >
        <div className="max-w-6xl mx-auto px-4 py-20 flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-sm md:max-w-md mx-auto flex items-center bg-white rounded-full p-2 shadow-lg">
            ...
            <Button
              size="icon"
              className="rounded-full cursor-pointer bg-[#0300A7] hover:bg-[#0300A7]"
            >
              <IconSearch size={20} />
            </Button>
          </div>
            ...
            <Accordion className="space-y-3">
              ...
              >
                <AccordionTrigger className="text-left text-sm font-medium">
                  I can’t see what I’m looking for on your website, does that
                  mean you don’t sell it?
                </AccordionTrigger>
                <AccordionContent className="text-sm text-gray-600">
                  Most of our products are listed on our website, however, if
                  you cannot find what you are looking for, we may have them
                  available so please contact us via sales@tkc.co.uk or call us.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-sm text-gray-600">
                  You can request a quote by contacting our sales team or
          ...
          <div className="mb-10">
            ...
            <Accordion className="space-y-3">
              ...
              >
                ...
                <AccordionContent className="text-sm text-gray-600">
                  We support both small and bulk orders. Contact our team for
                  more details.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="text-sm text-gray-600">
                  You can apply for a trade account by submitting your business
                  details through our registration form.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div>
            ...
            <Accordion className="space-y-3">
              ...
              >
                ...
                <AccordionContent className="text-sm text-gray-600">
                  T568A and T568B are two wiring standards used in networking
                  cables. The difference lies in wire color arrangement.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  typically dispatched the same day via next-day courier for UK
                  mainland addresses.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Faulty items can be returned within 30 days of purchase. For
                  non-faulty returns, a 15% restocking fee may apply. All
                  returns must have a valid RMA number.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="w-full bg-gray-200 py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 max-w-xl mx-auto mb-8">
            Can't find the answer you're looking for? Our technical support team
            is ready to help you with your specific requirements.
          </p>

          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button className="flex cursor-pointer items-center gap-2 bg-[#0300A7] hover:bg-[#0300A7]">
              <IconMail size={18} />
              Contact Support
            </Button>
